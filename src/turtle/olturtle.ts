...
import * as v from "../model/point"
import * as u from "../model/variable"
...
export class Turtle {
  ...
  constrain(from: v.Point, to: v.Point, length: k.AnyNum, sd: number = 1) {
  ...
  left(angle: v.Point): void {
    this.direction = v.subAngles(this.direction, angle)
  }

  right(angle: v.Point): void {
